    ...
    , ui(new Ui::MainWindow)
{
    ...
    ui->Home_button->setIcon(QIcon("/OOP/CPP-Project--SkyMate/SkyMate-main/C++/Icons/Home.png"));
    ui->Dashboard_button->setIcon(QIcon("/OOP/CPP-Project--SkyMate/SkyMate-main/C++/Icons/dashboard.png"));
    ui->Search_button->setIcon(QIcon("/OOP/CPP-Project--SkyMate/SkyMate-main/C++/Icons/search.png"));
    ui->Map_button->setIcon(QIcon("/OOP/CPP-Project--SkyMate/SkyMate-main/C++/Icons/map.png"));
    ui->Setting_button->setIcon(QIcon("/OOP/CPP-Project--SkyMate/SkyMate-main/C++/Icons/settings.png"));

    // Icons for the middle widgets in labels
    ui->uvindex_icon->setPixmap(QPixmap("/OOP/CPP-Project--SkyMate/SkyMate-main/C++/Icons/uvindex_icon.png"));
    ui->windspeed_icon->setPixmap(QPixmap("/OOP/CPP-Project--SkyMate/SkyMate-main/C++/Icons/windspeed_icon.png"));
    ui->humidity_icon->setPixmap(QPixmap("/OOP/CPP-Project--SkyMate/SkyMate-main/C++/Icons/humidity_icon.png"));
    ui->visibility_icon->setPixmap(QPixmap("/OOP/CPP-Project--SkyMate/SkyMate-main/C++/Icons/visibility_icon.png"));
    ui->feelslike_icon->setPixmap(QPixmap("/OOP/CPP-Project--SkyMate/SkyMate-main/C++/Icons/feelslike_icon.png"));
    ui->chanceofrain_icon->setPixmap(QPixmap("/OOP/CPP-Project--SkyMate/SkyMate-main/C++/Icons/chanceofrain_icon.png"));
    ui->pressure_icon->setPixmap(QPixmap("/OOP/CPP-Project--SkyMate/SkyMate-main/C++/Icons/pressure_icon.png"));
    ui->sunset_icon->setPixmap(QPixmap("/OOP/CPP-Project--SkyMate/SkyMate-main/C++/Icons/sunset_icon.png"));

    // Icons in the middle widget for weathericon indicator
    ui->weathericon_indicator->setPixmap(QPixmap("/OOP/CPP-Project--SkyMate/SkyMate-main/C++/Icons/sun_icon.png"));

    // Icons in the right widget
    // today's weather widget
    ui->weathericon_indicator_at_six->setPixmap(QPixmap("/OOP/CPP-Project--SkyMate/SkyMate-main/C++/Icons/cloudymightrain_icon.png"));
    ui->weathericon_indicator_at_nine->setPixmap(QPixmap("/OOP/CPP-Project--SkyMate/SkyMate-main/C++/Icons/cloudy_icon.png"));
    ui->weathericon_indicator_at_twelve->setPixmap(QPixmap("/OOP/CPP-Project--SkyMate/SkyMate-main/C++/Icons/sun_icon.png"));

    // 7Day Foorecast
    ui->monday_icon->setPixmap(QPixmap("/OOP/CPP-Project--SkyMate/SkyMate-main/C++/Icons/sun_icon.png"));
    ui->tuesday_icon->setPixmap(QPixmap("/OOP/CPP-Project--SkyMate/SkyMate-main/C++/Icons/sun_icon.png"));
    ui->wednesday_icon->setPixmap(QPixmap("/OOP/CPP-Project--SkyMate/SkyMate-main/C++/Icons/sun_icon.png"));
    ui->thursday_icon->setPixmap(QPixmap("/OOP/CPP-Project--SkyMate/SkyMate-main/C++/Icons/cloudy_icon.png"));
    ui->friday_icon->setPixmap(QPixmap("/OOP/CPP-Project--SkyMate/SkyMate-main/C++/Icons/cloudy_icon.png"));
    ui->saturday_icon->setPixmap(QPixmap("/OOP/CPP-Project--SkyMate/SkyMate-main/C++/Icons/cloudymightrain_icon.png"));
    ui->sunday_icon->setPixmap(QPixmap("/OOP/CPP-Project--SkyMate/SkyMate-main/C++/Icons/sun_icon.png"));
    ...
    if (!forecastWeatherJsonObject.isEmpty()) {
        ...
        for (const QJsonValue &dailyData : dailyList) {
            ...
            if (date.dayOfWeek() == Qt::Monday) {
                ...
                ui->monday_description->setText(daily_weather);
                if (daily_icon == "01d" || daily_icon == "01n"){
                    ui->monday_icon->setPixmap(QPixmap("/OOP/CPP-Project--SkyMate/SkyMate-main/C++/Icons/sun_icon.png"));
                }else if (daily_icon == "02d"|| daily_icon == "02n"){
                    ui->monday_icon->setPixmap(QPixmap("/OOP/CPP-Project--SkyMate/SkyMate-main/C++/Icons/Cloudy_icon.png"));
                }
                else if (daily_icon == "03d" || daily_icon == "03n"){
                    ui->monday_icon->setPixmap(QPixmap("/OOP/CPP-Project--SkyMate/SkyMate-main/C++/Icons/scattered_clouds_icon.png"));
                }
                else if (daily_icon == "04d"|| daily_icon == "04n"){
                    ui->monday_icon->setPixmap(QPixmap("/OOP/CPP-Project--SkyMate/SkyMate-main/C++/Icons/broken_clouds_icon.png"));
                }
                else if (daily_icon == "10d" || daily_icon == "09d"){
                    ui->monday_icon->setPixmap(QPixmap("/OOP/CPP-Project--SkyMate/SkyMate-main/C++/Icons/cloudymightrain_icon.png"));
                }
                else if (daily_icon == "11d"){
                    ui->monday_icon->setPixmap(QPixmap("/OOP/CPP-Project--SkyMate/SkyMate-main/C++/Icons/storm_icon.png"));
                }
                else if (daily_icon == "13d"){
                    ui->monday_icon->setPixmap(QPixmap("/OOP/CPP-Project--SkyMate/SkyMate-main/C++/Icons/snowy_icon.png"));
                }
                else if (daily_icon == "50d"){
                    ui->monday_icon->setPixmap(QPixmap("/OOP/CPP-Project--SkyMate-main/C++/Icnos/mist_icon.png"));
                }
                else {
                ...
                ui->saturday_description->setText(daily_weather);
                qDebug() << "Temp: " << temperatureText;

            } else if (date.dayOfWeek() == Qt::Sunday) {
                ui->sunday_temp->setText(temperatureText);
                ui->sunday_description->setText(daily_weather);
                qDebug() << "Temp: " << temperatureText;
