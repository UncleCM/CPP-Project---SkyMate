...
public slots:
void MainWindow::updateIndicators(const QString& cityName)
{
    const QString apiUrl = "https://api.open-meteo.com/weather?forecast=uvindex_1h";
    const QString requestUrl = apiUrl + "&city=" + cityName + "&daily=5&hourly=5&current_weather=true&timezone=auto&lang=en&current_weather_gradient=true&now=modified&daily_gradient=true&hourly_gradient=true&units=metric&indicators[]=uvindex";
    ...
    void MainWindow::handleNetworkReply(QNetworkReply* reply)
    {
        ...
        // and update the UI indicators

        // Example:
        int uvIndex = obj["uv_index"].toInt();
        ui->uvindex_value->setText(QString::number(uvIndex));
    }
