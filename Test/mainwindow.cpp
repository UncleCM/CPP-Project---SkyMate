    ...
    , setting(new Setting(this))
{
    ...
    ui->AirQuality_icon->setPixmap(QPixmap("/Users/User/Documents/SkyMate/Icons/AirQuality_icon.png"));
    ui->windspeed_icon->setPixmap(QPixmap("/Users/User/Documents/SkyMate/Icons/windspeed_icon.png"));
    ui->humidity_icon->setPixmap(QPixmap("/Users/User/Documents/SkyMate/Icons/humidity_icon.png"));
    ui->visibility_icon->setPixmap(QPixmap("/Users/User/Documents/SkyMate/Icons/visibility_icon.png"));
    ui->feelslike_icon->setPixmap(QPixmap("/Users/User/Documents/SkyMate/Icons/feelslike_icon.png"));
    ui->sunrise_icon->setPixmap(QPixmap("/Users/User/Documents/SkyMate/Icons/chanceofrain_icon.png"));
    ui->pressure_icon->setPixmap(QPixmap("/Users/User/Documents/SkyMate/Icons/pressure_icon.png"));
    ui->sunset_icon->setPixmap(QPixmap("/Users/User/Documents/SkyMate/Icons/sunset_icon.png"));


    // Icons in the middle widget for weathericon indicator
    ui->weathericon_indicator->setPixmap(QPixmap("/Users/User/Documents/SkyMate/Icons/sun_icon.png"));

    // Icons in the right widget
    // today's weather widget
    ui->weathericon_indicator_at_six->setPixmap(QPixmap("/Users/User/Documents/SkyMate/Icons/cloudymightrain_icon.png"));
    ui->weathericon_indicator_at_nine->setPixmap(QPixmap("/Users/User/Documents/SkyMate/Icons/cloudy_icon.png"));
    ui->weathericon_indicator_at_twelve->setPixmap(QPixmap("/Users/User/Documents/SkyMate/Icons/sun_icon.png"));

    // 7Day Foorecast
    ui->today_icon->setPixmap(QPixmap("/Users/User/Documents/SkyMate/Icons/sun_icon.png"));
    ui->tomorrow_icon->setPixmap(QPixmap("/Users/User/Documents/SkyMate/Icons/cloudy_icon.png"));
    ui->secondday_icon->setPixmap(QPixmap("/Users/User/Documents/SkyMate/Icons/cloudy_icon.png"));
    ui->thirdday_icon->setPixmap(QPixmap("/Users/User/Documents/SkyMate/Icons/cloudymightrain_icon.png"));
    ui->fourthday_icon->setPixmap(QPixmap("/Users/User/Documents/SkyMate/Icons/sun_icon.png"));
    ui->fifthday_icon->setPixmap(QPixmap("/Users/User/Documents/SkyMate/Icons/sun_icon.png"));
...
void MainWindow::updateUIFromApiResponse(const QJsonObject &jsonObject)
{
    if (!jsonObject.isEmpty()) {
        ...
        if (description == "01d" || description == "01n"){
            ...
            ui->weathericon_indicator->setPixmap(QPixmap("/Users/User/Documents/SkyMate/Icons/Cloudy_icon.png"));
        }
        else if (description == "03d" || description == "03n"){
            ui->weathericon_indicator->setPixmap(QPixmap("/Users/User/Documents/SkyMate/Icons/scattered_clouds_icon.png"));
        }
        else if (description == "04d"|| description == "04n"){
            ui->weathericon_indicator->setPixmap(QPixmap("/Users/User/Documents/SkyMate/Icons/broken_clouds_icon.png"));
        }
        else if (description == "10d" || description == "09d" || description == "10n" || description == "09n"){
            ui->weathericon_indicator->setPixmap(QPixmap("/Users/User/Documents/SkyMate/Icons/cloudymightrain_icon.png"));
        }
        else if (description == "11d" || description == "11n"){
            ui->weathericon_indicator->setPixmap(QPixmap("/Users/User/Documents/SkyMate/Icons/storm_icon.png"));
        }
        else if (description == "13d" || description == "13n"){
            ui->weathericon_indicator->setPixmap(QPixmap("/Users/User/Documents/SkyMate/Icons/snowy_icon.png"));
        }
        else if (description == "50d" || description == "50n"){
            ui->weathericon_indicator->setPixmap(QPixmap("/Users/User/Documents/SkyMate/Icons/mist_icon.png"));
        }
        else {
            ui->weathericon_indicator->clear();
        }
    ...
    for (const QJsonValue &hourlyData : hourlyList) {
        ...
        if (dateTime.time().hour() == 6) {
            ...
            if (hourly_icon == "01d" || hourly_icon == "01n"){
                ui->weathericon_indicator_at_six->setPixmap(QPixmap("/Users/User/Documents/SkyMate/Icons/sun_icon.png"));
            }else if (hourly_icon == "02d"|| hourly_icon == "02n"){
                ui->weathericon_indicator_at_six->setPixmap(QPixmap("/Users/User/Documents/SkyMate/Icons/Cloudy_icon.png"));
            }
            else if (hourly_icon == "03d" || hourly_icon == "03n"){
                ui->weathericon_indicator_at_six->setPixmap(QPixmap("/Users/User/Documents/SkyMate/Icons/scattered_clouds_icon.png"));
            }
            else if (hourly_icon == "04d"|| hourly_icon == "04n"){
                ui->weathericon_indicator_at_six->setPixmap(QPixmap("/Users/User/Documents/SkyMate/Icons/broken_clouds_icon.png"));
            }
            else if (hourly_icon == "10d" || hourly_icon == "09d" || hourly_icon == "10n" || hourly_icon == "9n"){
                ui->weathericon_indicator_at_six->setPixmap(QPixmap("/Users/User/Documents/SkyMate/Icons/cloudymightrain_icon.png"));
            }
            else if (hourly_icon == "11d" || hourly_icon == "11n"){
                ui->weathericon_indicator_at_six->setPixmap(QPixmap("/Users/User/Documents/SkyMate/Icons/storm_icon.png"));
            }
            else if (hourly_icon == "13d" || hourly_icon == "13d"){
                ui->weathericon_indicator_at_six->setPixmap(QPixmap("/Users/User/Documents/SkyMate/Icons/snowy_icon.png"));
            }
            else if (hourly_icon == "50d" || hourly_icon == "50d"){
                ui->weathericon_indicator_at_six->setPixmap(QPixmap("/Users/User/Documents/SkyMate/Icons/mist_icon.png"));
            }
            else {
                ui->weathericon_indicator_at_six->clear();
            }
            ...
            if (hourly_icon == "01d" || hourly_icon == "01n"){
                ui->weathericon_indicator_at_nine->setPixmap(QPixmap("/Users/User/Documents/SkyMate/Icons/sun_icon.png"));
            }else if (hourly_icon == "02d"|| hourly_icon == "02n"){
                ui->weathericon_indicator_at_nine->setPixmap(QPixmap("/Users/User/Documents/SkyMate/Icons/Cloudy_icon.png"));
            }
            else if (hourly_icon == "03d" || hourly_icon == "03n"){
                ui->weathericon_indicator_at_nine->setPixmap(QPixmap("/Users/User/Documents/SkyMate/Icons/scattered_clouds_icon.png"));
            }
            else if (hourly_icon == "04d"|| hourly_icon == "04n"){
                ui->weathericon_indicator_at_nine->setPixmap(QPixmap("/Users/User/Documents/SkyMate/Icons/broken_clouds_icon.png"));
            }
            else if (hourly_icon == "10d" || hourly_icon == "09d" || hourly_icon == "10n" || hourly_icon == "9n"){
                ui->weathericon_indicator_at_nine->setPixmap(QPixmap("/Users/User/Documents/SkyMate/Icons/cloudymightrain_icon.png"));
            }
            else if (hourly_icon == "11d" || hourly_icon == "11n"){
                ui->weathericon_indicator_at_nine->setPixmap(QPixmap("/Users/User/Documents/SkyMate/Icons/storm_icon.png"));
            }
            else if (hourly_icon == "13d" || hourly_icon == "13d"){
                ui->weathericon_indicator_at_nine->setPixmap(QPixmap("/Users/User/Documents/SkyMate/Icons/snowy_icon.png"));
            }
            else if (hourly_icon == "50d" || hourly_icon == "50d"){
                ui->weathericon_indicator_at_nine->setPixmap(QPixmap("/Users/User/Documents/SkyMate/Icons/mist_icon.png"));
            }
            else {
                ui->weathericon_indicator_at_nine->clear();
            }
            ...
            if (hourly_icon == "01d" || hourly_icon == "01n"){
                ...
                ui->weathericon_indicator_at_twelve->setPixmap(QPixmap("/Users/User/Documents/SkyMate/Icons/Cloudy_icon.png"));
            }
            else if (hourly_icon == "03d" || hourly_icon == "03n"){
                ui->weathericon_indicator_at_twelve->setPixmap(QPixmap("/Users/User/Documents/SkyMate/Icons/scattered_clouds_icon.png"));
            }
            else if (hourly_icon == "04d"|| hourly_icon == "04n"){
                ui->weathericon_indicator_at_twelve->setPixmap(QPixmap("/Users/User/Documents/SkyMate/Icons/broken_clouds_icon.png"));
            }
            else if (hourly_icon == "10d" || hourly_icon == "09d" || hourly_icon == "10n" || hourly_icon == "9n"){
                ui->weathericon_indicator_at_twelve->setPixmap(QPixmap("/Users/User/Documents/SkyMate/Icons/cloudymightrain_icon.png"));
            }
            else if (hourly_icon == "11d" || hourly_icon == "11n"){
                ui->weathericon_indicator_at_twelve->setPixmap(QPixmap("/Users/User/Documents/SkyMate/Icons/storm_icon.png"));
            }
            else if (hourly_icon == "13d" || hourly_icon == "13d"){
                ui->weathericon_indicator_at_twelve->setPixmap(QPixmap("/Users/User/Documents/SkyMate/Icons/snowy_icon.png"));
            }
            else if (hourly_icon == "50d" || hourly_icon == "50d"){
                ui->weathericon_indicator_at_twelve->setPixmap(QPixmap("/Users/User/Documents/SkyMate/Icons/mist_icon.png"));
            }
            else {
                ui->weathericon_indicator_at_twelve->clear();
            }
...
void setWeatherIcon(QLabel* iconLabel, const QString& iconCode)
{
    if (iconCode == "01d" || iconCode == "01n") {
        iconLabel->setPixmap(QPixmap("/Users/User/Documents/SkyMate/Icons/sun_icon.png"));
    } else if (iconCode == "02d" || iconCode == "02n") {
        iconLabel->setPixmap(QPixmap("/Users/User/Documents/SkyMate/Icons/Cloudy_icon.png"));
    } else if (iconCode == "03d" || iconCode == "03n") {
        iconLabel->setPixmap(QPixmap("/Users/User/Documents/SkyMate/Icons/scattered_clouds_icon.png"));
    } else if (iconCode == "04d" || iconCode == "04n") {
        iconLabel->setPixmap(QPixmap("/Users/User/Documents/SkyMate/Icons/broken_clouds_icon.png"));
    } else if (iconCode == "10d" || iconCode == "09d" || iconCode == "10n" || iconCode == "9n") {
        iconLabel->setPixmap(QPixmap("/Users/User/Documents/SkyMate/Icons/cloudymightrain_icon.png"));
    } else if (iconCode == "11d" || iconCode == "11n") {
        iconLabel->setPixmap(QPixmap("/Users/User/Documents/SkyMate/Icons/storm_icon.png"));
    } else if (iconCode == "13d" || iconCode == "13n") {
        iconLabel->setPixmap(QPixmap("/Users/User/Documents/SkyMate/Icons/snowy_icon.png"));
    } else if (iconCode == "50d" || iconCode == "50n") {
        iconLabel->setPixmap(QPixmap("/Users/User/Documents/SkyMate/Icons/mist_icon.png"));
    } else {
        iconLabel->clear();
    }
}
